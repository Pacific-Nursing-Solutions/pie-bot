                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <div className="relative group">
                            ...
                            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-gray-900 dark:bg-gray-700 text-white text-xs rounded px-2 py-1 whitespace-nowrap pointer-events-none z-10">
                              {document.size} • Created: {new Date(document.createdDate).toLocaleDateString()}
                            </div>
                          </div>
                        </div>
