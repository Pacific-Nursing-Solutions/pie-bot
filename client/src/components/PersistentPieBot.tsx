...
import { ChevronDown, ChevronUp, MessageSquare, X, Send } from "lucide-react";
...
export default function PersistentPieBot({ isMinimized = true }: PersistentPieBotProps) {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 ${
        isCollapsed ? 'w-80 h-16' : 'w-96 h-96'
      }`}>
        {/* Header */}
        <div 
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {isCollapsed ? "Click to expand" : "Your equity assistant"}
              </p>
            </div>
          </div>
          <button className="p-1 text-gray-500 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
